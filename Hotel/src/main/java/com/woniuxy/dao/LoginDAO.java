...
public interface LoginDAO {
	...
	@Results({ @Result(id = true, property = "login_id", column = "login_id"),
			@Result(property = "account", column = "account"), @Result(property = "pwd", column = "pwd"),
			@Result(property = "member_id", column = "member_id"), @Result(property = "flag", column = "flag"),
			@Result(property = "persons", column = "login_id", one = @One(select = "com.woniuxy.dao.PersonDAO.findPersonByLogin_id")) })
